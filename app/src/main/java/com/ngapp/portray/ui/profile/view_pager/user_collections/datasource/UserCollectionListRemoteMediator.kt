package com.ngapp.portray.ui.profile.view_pager.user_collections.datasource
...
class UserCollectionListRemoteMediator(
    private val api: Api,
...
//                prevKey
        ...
        try {
            ...
            val collections = api.getUserCollections(username, page, state.config.pageSize)
            collections.forEach {
