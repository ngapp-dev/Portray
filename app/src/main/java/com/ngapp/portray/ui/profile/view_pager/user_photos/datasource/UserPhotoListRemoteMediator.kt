package com.ngapp.portray.ui.profile.view_pager.user_photos.datasource
...
class UserPhotoListRemoteMediator(
    private val api: Api,
...
//                prevKey
        ...
        try {
            ...
            val photos = api.getUserPhotos(username, page, state.config.pageSize)
            photos.forEach {
