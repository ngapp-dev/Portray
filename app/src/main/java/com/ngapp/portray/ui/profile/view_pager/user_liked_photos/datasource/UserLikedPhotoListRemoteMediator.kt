package com.ngapp.portray.ui.profile.view_pager.user_liked_photos.datasource
...
class UserLikedPhotoListRemoteMediator(
    private val api: Api,
...
//                    prevKey
            ...
            val photos = api.getUserLikedPhotos(username, page, state.config.pageSize)
            photos.forEach {
...
//                    photoRemoteKeysDao.clearRe-moteKeys()
